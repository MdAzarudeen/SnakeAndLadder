...
public class SnakeAndLadder extends Application {
    ...
    private boolean gameStarted = true, playerOneTurn = false, playerTwoTurn = false;
    private Pane createContent(){
        ...
        Image img = new Image("C:\\Users\\c8949053\\IdeaProjects\\SnakeAndLadder\\src\\main\\img.png");
...
//        info Display
        ...
        playerOne = new Player(tileSize, Color.BLACK, "AZAR");
        playerTwo = new Player(tileSize-5,Color.WHITE,"DIYAN");
